...
<html>
  <head>
    <meta charset="utf-8">    
    <title>Yoga Practice: Stress Relief</title>
...
function checkSession(){
  ...
  ********************************************************************/
  ...
  /* check for incorrect length or invalid input */
  if(title > 20){
    document.getElementById("output8").innerHTML = "Please enter a title that is 20 characters or less";
    document.getElementById("AddFormBal").reset();
   return;
  }

  if(isNaN(length)){
    document.getElementById("output8").innerHTML ="Length input should be numeric.";
    document.getElementById("AddFormBal").reset();
    return;
  }
    ...
    /* horrible things I can't predict */
     else if(req.responseText != 1 && req.responseText != 0){
          document.getElementById("output8").innerHTML = req.responseText;
       }
    }
  }
  ...
  <div>
    ...
    <ul id="menu">
      ...
      <li><a href="http://web.engr.oregonstate.edu/~masseyta/final/Relief.php">Relief</a></li>
  ...
  <?php
    ...
    echo "<p>";
      echo "<h2>Welcome to your Relief Practice, ".$_SESSION['username']."!</h2>";
