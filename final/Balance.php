...
<html>
  <head>
    <meta charset="utf-8">    
    <title>Yoga Practice: Balancing</title>
...
function checkSession(){
  ...
  ********************************************************************/
  ...
  if(title > 20){
    document.getElementById("output3").innerHTML = "Please enter a title that is 20 characters or less";
    document.getElementById("AddFormBal").reset();
   return;
  }

  if(isNaN(length)){
    document.getElementById("output3").innerHTML ="Length input should be numeric.";
    document.getElementById("AddFormBal").reset();
    return;
  }
    ...
    if(req.responseText == 0){
      document.getElementById("output3").innerHTML = "Error adding practice to log.";
      document.getElementById("AddFormBal").reset(); 
    }

    /* horribleness has occured. Tell me what it was */
     else if(req.responseText != 1 && req.responseText != 0){
          document.getElementById("output3").innerHTML = req.responseText;
       }
    }
  }
  ...
  <div>
    ...
    echo "<p>";
      echo "<h2>Welcome to your Balance Practice, ".$_SESSION['username']."!</h2>";
