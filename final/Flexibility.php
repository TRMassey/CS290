...
<html>
  <head>
    <meta charset="utf-8">    
    <title>Yoga Practice: Flexibility</title>
...
function checkSession(){
  ...
  ********************************************************************/
  ...
  if(title > 20){
    document.getElementById("Output5").innerHTML = "Please enter a title that is 20 characters or less";
    document.getElementById("AddFormFlex").reset();
   return;
  }

  if(isNaN(length)){
    document.getElementById("Output5").innerHTML ="Length input should be numeric.";
    document.getElementById("AddFormFlex").reset();
    return;
  }
    ...
    /* horrible things */
          ...
          document.getElementById("Output5").innerHTML = req.responseText;
       }
    }
  }
  ...
  <div>
    ...
    echo "<p>";
      echo "<h2>Welcome to your Flexibility Practice, ".$_SESSION['username']."!</h2>";
